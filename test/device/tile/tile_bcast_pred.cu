 ...
 */
 ...
 #define DECL_TYPENAME_TILE_PUT(OP, SC, SC_SUFFIX, SC_PREFIX, TYPENAME, TYPE)                      \
     __global__ void test_##TYPENAME##_tile_bcast_kernel##SC_SUFFIX(                               \
...
#define VALIDATE_TILE_BCAST_DATA(OP, SC, SC_SUFFIX, SC_PREFIX, TYPENAME, TYPE)                   \
...
NVSHMEMTEST_TILE_REPT_TYPES_AND_SCOPES(VALIDATE_TILE_BCAST_DATA, NA)
#undef VALIDATE_TILE_BCAST_DATA

#define DEFN_TYPENAME_TILE_BCAST(OP, SC, SC_SUFFIX, SC_PREFIX, TYPENAME, TYPE, VLN)               \
    ...
    __global__ void test_##TYPENAME##_tile_bcast_kernel_v##VLN##SC_SUFFIX(                        \
        ...
        for (int i = blockIdx.x * SC##s_per_block; i < num_tiles_major * num_tiles_minor;         \
            ...
            if (my_pe == 0) {                                                                     \
                nvshmemx::tile_broadcast##SC_SUFFIX<                                              \
