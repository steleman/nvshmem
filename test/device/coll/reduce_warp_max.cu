 ...
 */
#define CUMODULE_NAME "reduce_warp_max.cubin"
...
NVSHMEMTEST_REPT_FOR_STANDARD_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, warp, _warp, x, max)
...
NVSHMEMTEST_REPT_FOR_STANDARD_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, warp, _warp, x, max)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
