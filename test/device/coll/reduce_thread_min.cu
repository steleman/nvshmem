 ...
 */
#define CUMODULE_NAME "reduce_thread_min.cubin"
...
NVSHMEMTEST_REPT_FOR_STANDARD_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, thread, , , min)
...
NVSHMEMTEST_REPT_FOR_STANDARD_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, thread, , , min)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
