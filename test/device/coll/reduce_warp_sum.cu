 ...
 */
#define CUMODULE_NAME "reduce_warp_sum.cubin"
...
NVSHMEMTEST_REPT_FOR_ARITH_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, warp, _warp, x, sum)
...
NVSHMEMTEST_REPT_FOR_ARITH_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, warp, _warp, x, sum)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
