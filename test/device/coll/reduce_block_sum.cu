 ...
 */
#define CUMODULE_NAME "reduce_block_sum.cubin"
...
NVSHMEMTEST_REPT_FOR_ARITH_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, block, _block, x, sum)
...
NVSHMEMTEST_REPT_FOR_ARITH_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, block, _block, x, sum)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
