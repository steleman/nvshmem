 ...
 */
#define CUMODULE_NAME "reduce_warp_or.cubin"
...
NVSHMEMTEST_REPT_FOR_BITWISE_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, warp, _warp, x, or)
...
NVSHMEMTEST_REPT_FOR_BITWISE_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, warp, _warp, x, or)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
